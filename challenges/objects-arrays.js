...
zooAnimals.forEach(function(array) {
    displayNames.push(array.animal_name);
    displayNames.push(array.scientific_name);
});
...
const lowPopulationAnimals = filler.filter(function(value) {
    return value < 5;
});
